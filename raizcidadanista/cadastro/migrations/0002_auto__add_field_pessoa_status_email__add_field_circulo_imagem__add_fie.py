...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pessoa.status_email'
        db.add_column('cadastro_pessoa', 'status_email',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)

        # Adding field 'Circulo.imagem'
        db.add_column('cadastro_circulo', 'imagem',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Circulo.status'
        db.add_column('cadastro_circulo', 'status',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pessoa.status_email'
        db.delete_column('cadastro_pessoa', 'status_email')

        # Deleting field 'Circulo.imagem'
        db.delete_column('cadastro_circulo', 'imagem')

        # Deleting field 'Circulo.status'
        db.delete_column('cadastro_circulo', 'status')
