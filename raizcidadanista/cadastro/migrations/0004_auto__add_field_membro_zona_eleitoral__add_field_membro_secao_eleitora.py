...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membro.zona_eleitoral'
        db.add_column('cadastro_membro', 'zona_eleitoral',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membro.secao_eleitoral'
        db.add_column('cadastro_membro', 'secao_eleitoral',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membro.zona_eleitoral'
        db.delete_column('cadastro_membro', 'zona_eleitoral')

        # Deleting field 'Membro.secao_eleitoral'
        db.delete_column('cadastro_membro', 'secao_eleitoral')
    ...
    models = {
        ...
        'cadastro.membro': {
            ...
            'secao_eleitoral': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'zona_eleitoral': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        'cadastro.pessoa': {
