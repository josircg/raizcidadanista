...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membro.cpf'
        db.add_column('cadastro_membro', 'cpf',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membro.nome_da_mae'
        db.add_column('cadastro_membro', 'nome_da_mae',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Membro.secao_eleitoral'
        db.alter_column('cadastro_membro', 'secao_eleitoral', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'Membro.zona_eleitoral'
        db.alter_column('cadastro_membro', 'zona_eleitoral', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

    def backwards(self, orm):
        # Deleting field 'Membro.cpf'
        db.delete_column('cadastro_membro', 'cpf')

        # Deleting field 'Membro.nome_da_mae'
        db.delete_column('cadastro_membro', 'nome_da_mae')


        # Changing field 'Membro.secao_eleitoral'
        db.alter_column('cadastro_membro', 'secao_eleitoral', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Membro.zona_eleitoral'
        db.alter_column('cadastro_membro', 'zona_eleitoral', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
