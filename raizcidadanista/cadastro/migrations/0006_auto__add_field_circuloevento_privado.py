...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CirculoEvento.privado'
        db.add_column('cadastro_circuloevento', 'privado',
    ...
    def backwards(self, orm):
        # Deleting field 'CirculoEvento.privado'
        db.delete_column('cadastro_circuloevento', 'privado')
