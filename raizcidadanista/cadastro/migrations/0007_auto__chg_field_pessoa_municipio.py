...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pessoa.municipio'
        db.alter_column('cadastro_pessoa', 'municipio', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Pessoa.municipio'
        db.alter_column('cadastro_pessoa', 'municipio', self.gf('django.db.models.fields.CharField')(default=0, max_length=150))
