...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Lista'
        db.create_table('cadastro_lista', (
            ...
            ('seo', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('analytics', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('cadastro', ['Lista'])

        # Adding model 'ListaCadastro'
        db.create_table('cadastro_listacadastro', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lista', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Lista'])),
            ('pessoa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Pessoa'])),
            ('dtinclusao', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('cadastro', ['ListaCadastro'])


    def backwards(self, orm):
        # Deleting model 'Lista'
        db.delete_table('cadastro_lista')

        # Deleting model 'ListaCadastro'
        db.delete_table('cadastro_listacadastro')
