...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cadastro_campanha', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lista', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Lista'], null=True, on_delete=models.SET_NULL)),
            ('dtenvio', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('assunto', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('template', self.gf('django.db.models.fields.TextField')()),
            ('qtde_envio', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('qtde_erros', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('qtde_views', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('cadastro', ['Campanha'])


    def backwards(self, orm):
        # Deleting model 'Campanha'
        db.delete_table('cadastro_campanha')
