...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Circulo.grupo'
        db.add_column('cadastro_circulo', 'grupo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Grupo'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CirculoMembro.grupousuario'
        db.add_column('cadastro_circulomembro', 'grupousuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.GrupoUsuario'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Circulo.grupo'
        db.delete_column('cadastro_circulo', 'grupo_id')

        # Deleting field 'CirculoMembro.grupousuario'
        db.delete_column('cadastro_circulomembro', 'grupousuario_id')
