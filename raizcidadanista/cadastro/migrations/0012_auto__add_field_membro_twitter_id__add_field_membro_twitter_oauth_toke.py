...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membro.twitter_id'
        db.add_column('cadastro_membro', 'twitter_id',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membro.twitter_oauth_token'
        db.add_column('cadastro_membro', 'twitter_oauth_token',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membro.twitter_oauth_token_secret'
        db.add_column('cadastro_membro', 'twitter_oauth_token_secret',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membro.twitter_id'
        db.delete_column('cadastro_membro', 'twitter_id')

        # Deleting field 'Membro.twitter_oauth_token'
        db.delete_column('cadastro_membro', 'twitter_oauth_token')

        # Deleting field 'Membro.twitter_oauth_token_secret'
        db.delete_column('cadastro_membro', 'twitter_oauth_token_secret')
