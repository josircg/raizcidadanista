...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membro.contrib_prox_pgto'
        db.add_column('cadastro_membro', 'contrib_prox_pgto',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membro.contrib_prox_pgto'
        db.delete_column('cadastro_membro', 'contrib_prox_pgto')
