...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membro.dt_prefiliacao'
        db.add_column('cadastro_membro', 'dt_prefiliacao',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membro.dt_prefiliacao'
        db.delete_column('cadastro_membro', 'dt_prefiliacao')
