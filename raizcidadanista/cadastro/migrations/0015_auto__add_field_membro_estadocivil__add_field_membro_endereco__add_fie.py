...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membro.estadocivil'
        db.add_column('cadastro_membro', 'estadocivil',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membro.endereco'
        db.add_column('cadastro_membro', 'endereco',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membro.endereco_num'
        db.add_column('cadastro_membro', 'endereco_num',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membro.endereco_complemento'
        db.add_column('cadastro_membro', 'endereco_complemento',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membro.estadocivil'
        db.delete_column('cadastro_membro', 'estadocivil')

        # Deleting field 'Membro.endereco'
        db.delete_column('cadastro_membro', 'endereco')

        # Deleting field 'Membro.endereco_num'
        db.delete_column('cadastro_membro', 'endereco_num')

        # Deleting field 'Membro.endereco_complemento'
        db.delete_column('cadastro_membro', 'endereco_complemento')
