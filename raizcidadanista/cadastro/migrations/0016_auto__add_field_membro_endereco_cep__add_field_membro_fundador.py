...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membro.endereco_cep'
        db.add_column('cadastro_membro', 'endereco_cep',
                      self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Membro.fundador'
        db.add_column('cadastro_membro', 'fundador',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membro.endereco_cep'
        db.delete_column('cadastro_membro', 'endereco_cep')

        # Deleting field 'Membro.fundador'
        db.delete_column('cadastro_membro', 'fundador')
