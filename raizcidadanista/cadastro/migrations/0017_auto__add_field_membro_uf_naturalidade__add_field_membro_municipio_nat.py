...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membro.uf_naturalidade'
        db.add_column('cadastro_membro', 'uf_naturalidade',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='uf_naturalidade', null=True, to=orm['municipios.UF']),
                      keep_default=False)

        # Adding field 'Membro.municipio_naturalidade'
        db.add_column('cadastro_membro', 'municipio_naturalidade',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membro.uf_naturalidade'
        db.delete_column('cadastro_membro', 'uf_naturalidade_id')

        # Deleting field 'Membro.municipio_naturalidade'
        db.delete_column('cadastro_membro', 'municipio_naturalidade')
