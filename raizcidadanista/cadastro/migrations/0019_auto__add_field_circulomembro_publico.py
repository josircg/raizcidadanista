...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CirculoMembro.publico'
        db.add_column('cadastro_circulomembro', 'publico',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CirculoMembro.publico'
        db.delete_column('cadastro_circulomembro', 'publico')
