...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CirculoMembro', fields ['circulo', 'membro']
        db.create_unique('cadastro_circulomembro', ['circulo_id', 'membro_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CirculoMembro', fields ['circulo', 'membro']
        db.delete_unique('cadastro_circulomembro', ['circulo_id', 'membro_id'])
