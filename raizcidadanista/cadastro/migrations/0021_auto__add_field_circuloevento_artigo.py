...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CirculoEvento.artigo'
        db.add_column('cadastro_circuloevento', 'artigo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Article'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CirculoEvento.artigo'
        db.delete_column('cadastro_circuloevento', 'artigo_id')
