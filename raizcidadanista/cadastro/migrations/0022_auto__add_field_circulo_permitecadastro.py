...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Circulo.permitecadastro'
        db.add_column('cadastro_circulo', 'permitecadastro',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Circulo.permitecadastro'
        db.delete_column('cadastro_circulo', 'permitecadastro')
