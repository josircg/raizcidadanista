...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campanha.tipo'
        db.add_column('cadastro_campanha', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='L', max_length=1),
                      keep_default=False)

        # Adding field 'Campanha.circulo_membro'
        db.add_column('cadastro_campanha', 'circulo_membro',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='campanha_circulo_membro', null=True, on_delete=models.SET_NULL, to=orm['cadastro.Circulo']),
                      keep_default=False)

        # Adding field 'Campanha.circulo_visitante'
        db.add_column('cadastro_campanha', 'circulo_visitante',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='campanha_circulo_visitante', null=True, on_delete=models.SET_NULL, to=orm['cadastro.Circulo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campanha.tipo'
        db.delete_column('cadastro_campanha', 'tipo')

        # Deleting field 'Campanha.circulo_membro'
        db.delete_column('cadastro_campanha', 'circulo_membro_id')

        # Deleting field 'Campanha.circulo_visitante'
        db.delete_column('cadastro_campanha', 'circulo_visitante_id')
