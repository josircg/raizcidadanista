...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ColetaArticulacao'
        db.create_table('cadastro_coletaarticulacao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('UF', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['municipios.UF'])),
            ('municipio', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['municipios.Municipio'], null=True, blank=True)),
            ('zona', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('articulador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro'])),
        ))
        db.send_create_signal('cadastro', ['ColetaArticulacao'])


    def backwards(self, orm):
        # Deleting model 'ColetaArticulacao'
        db.delete_table('cadastro_coletaarticulacao')
