...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Circulo.slug'
        db.add_column('cadastro_circulo', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Circulo.slug'
        db.delete_column('cadastro_circulo', 'slug')
