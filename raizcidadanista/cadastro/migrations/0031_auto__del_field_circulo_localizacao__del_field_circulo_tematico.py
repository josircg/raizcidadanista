...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Circulo.localizacao'
        db.delete_column('cadastro_circulo', 'localizacao')

        # Deleting field 'Circulo.tematico'
        db.delete_column('cadastro_circulo', 'tematico')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Circulo.localizacao'
        raise RuntimeError("Cannot reverse this migration. 'Circulo.localizacao' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Circulo.localizacao'
        db.add_column('cadastro_circulo', 'localizacao',
                      self.gf('django.db.models.fields.CharField')(max_length=1),
                      keep_default=False)

        # Adding field 'Circulo.tematico'
        db.add_column('cadastro_circulo', 'tematico',
