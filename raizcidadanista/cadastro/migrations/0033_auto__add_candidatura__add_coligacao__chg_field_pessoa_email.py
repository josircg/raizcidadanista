...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Candidatura'
        db.create_table('cadastro_candidatura', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coligacao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Coligacao'])),
            ('candidato', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro'])),
            ('cargo', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('cadastro', ['Candidatura'])

        # Adding model 'Coligacao'
        db.create_table('cadastro_coligacao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('UF', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['municipios.UF'])),
            ('municipio', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['municipios.Municipio'])),
            ('partido', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('majoritaria', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('cadastro', ['Coligacao'])


        # Changing field 'Pessoa.email'
        db.alter_column('cadastro_pessoa', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):
        # Deleting model 'Candidatura'
        db.delete_table('cadastro_candidatura')

        # Deleting model 'Coligacao'
        db.delete_table('cadastro_coligacao')


        # Changing field 'Pessoa.email'
        db.alter_column('cadastro_pessoa', 'email', self.gf('django.db.models.fields.EmailField')(default='a@a', max_length=75))
    ...
    models = {
        ...
        'cadastro.coligacao': {
            ...
            'UF': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['municipios.UF']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'majoritaria': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
