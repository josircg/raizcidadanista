...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidatura.eleito'
        db.add_column('cadastro_candidatura', 'eleito',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Coligacao.majoritaria'
        db.alter_column('cadastro_coligacao', 'majoritaria', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Deleting field 'Candidatura.eleito'
        db.delete_column('cadastro_candidatura', 'eleito')


        # User chose to not deal with backwards NULL issues for 'Coligacao.majoritaria'
        raise RuntimeError("Cannot reverse this migration. 'Coligacao.majoritaria' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Coligacao.majoritaria'
        db.alter_column('cadastro_coligacao', 'majoritaria', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'cadastro.coligacao': {
            ...
            'UF': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['municipios.UF']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'majoritaria': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
