...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidatura.partido'
        db.add_column('cadastro_candidatura', 'partido',
                      self.gf('django.db.models.fields.CharField')(default='PSOL', max_length=50),
                      keep_default=False)

        # Deleting field 'Coligacao.majoritaria'
        db.delete_column('cadastro_coligacao', 'majoritaria')

        # Deleting field 'Coligacao.partido'
        db.delete_column('cadastro_coligacao', 'partido')

        # Adding field 'Coligacao.partidos'
        db.add_column('cadastro_coligacao', 'partidos',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidatura.partido'
        db.delete_column('cadastro_candidatura', 'partido')

        # Adding field 'Coligacao.majoritaria'
        db.add_column('cadastro_coligacao', 'majoritaria',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Coligacao.partido'
        db.add_column('cadastro_coligacao', 'partido',
                      self.gf('django.db.models.fields.CharField')(default='PSOL', max_length=50),
                      keep_default=False)

        # Deleting field 'Coligacao.partidos'
        db.delete_column('cadastro_coligacao', 'partidos')
