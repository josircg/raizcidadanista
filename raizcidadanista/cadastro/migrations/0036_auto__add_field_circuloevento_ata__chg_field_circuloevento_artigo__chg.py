...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CirculoEvento.ata'
        db.add_column('cadastro_circuloevento', 'ata',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CirculoEvento.artigo'
        db.alter_column('cadastro_circuloevento', 'artigo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Article'], null=True, on_delete=models.SET_NULL))

        # Changing field 'CirculoMembro.grupousuario'
        db.alter_column('cadastro_circulomembro', 'grupousuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.GrupoUsuario'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'CirculoEvento.ata'
        db.delete_column('cadastro_circuloevento', 'ata')


        # Changing field 'CirculoEvento.artigo'
        db.alter_column('cadastro_circuloevento', 'artigo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Article'], null=True))

        # Changing field 'CirculoMembro.grupousuario'
        db.alter_column('cadastro_circulomembro', 'grupousuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.GrupoUsuario'], null=True))
