...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CirculoPendente'
        db.create_table('cadastro_circulopendente', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=80, blank=True)),
            ...
            ('permitecadastro', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Grupo'], null=True, blank=True)),
            ...
            ('dtcriacao', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('area_geografica', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('num_membros', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('num_membros_coleta', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('jardineiro_1_nome', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('jardineiro_1_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('jardineiro_1_telefone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('jardineiro_2_nome', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('jardineiro_2_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('jardineiro_2_telefone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ferramentas', self.gf('cms.fields.ListField')()),
        ))
        db.send_create_signal('cadastro', ['CirculoPendente'])


    def backwards(self, orm):
        # Deleting model 'CirculoPendente'
        db.delete_table('cadastro_circulopendente')
    ...
    models = {
        ...
        'cadastro.circulopendente': {
            'Meta': {'ordering': "('tipo', 'titulo')", 'object_name': 'CirculoPendente'},
            'area_geografica': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'autor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'descricao': ('django.db.models.fields.TextField', [], {}),
            'dtcadastro': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            'dtcriacao': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
            'ferramentas': ('cms.fields.ListField', [], {}),
            'grupo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forum.Grupo']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagem': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'jardineiro_1_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'jardineiro_1_nome': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'jardineiro_1_telefone': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'jardineiro_2_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'jardineiro_2_nome': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'jardineiro_2_telefone': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'municipio': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'num_membros': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'num_membros_coleta': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'oficial': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'permitecadastro': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Section']", 'null': 'True', 'blank': 'True'}),
            'site_externo': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
