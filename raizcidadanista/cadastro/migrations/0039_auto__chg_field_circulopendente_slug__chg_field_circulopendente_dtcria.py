...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CirculoPendente.slug'
        db.alter_column('cadastro_circulopendente', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))

        # Changing field 'CirculoPendente.dtcriacao'
        db.alter_column('cadastro_circulopendente', 'dtcriacao', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'CirculoPendente.ferramentas'
        db.alter_column('cadastro_circulopendente', 'ferramentas', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'CirculoPendente.slug'
        db.alter_column('cadastro_circulopendente', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=80))

        # Changing field 'CirculoPendente.dtcriacao'
        db.alter_column('cadastro_circulopendente', 'dtcriacao', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'CirculoPendente.ferramentas'
        db.alter_column('cadastro_circulopendente', 'ferramentas', self.gf('cms.fields.ListField')())
