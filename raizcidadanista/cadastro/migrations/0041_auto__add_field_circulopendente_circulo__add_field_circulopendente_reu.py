...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CirculoPendente.circulo'
        db.add_column('cadastro_circulopendente', 'circulo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Circulo'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CirculoPendente.reunioes'
        db.add_column('cadastro_circulopendente', 'reunioes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CirculoPendente.atividades'
        db.add_column('cadastro_circulopendente', 'atividades',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CirculoPendente.circulo'
        db.delete_column('cadastro_circulopendente', 'circulo_id')

        # Deleting field 'CirculoPendente.reunioes'
        db.delete_column('cadastro_circulopendente', 'reunioes')

        # Deleting field 'CirculoPendente.atividades'
        db.delete_column('cadastro_circulopendente', 'atividades')
    ...
    models = {
        ...
        'cadastro.circulopendente': {
            ...
            'circulo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cadastro.Circulo']", 'null': 'True', 'blank': 'True'}),
            'descricao': ('django.db.models.fields.TextField', [], {}),
            'dtcadastro': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            'dtcriacao': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            'ferramentas': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'grupo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forum.Grupo']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagem': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'oficial': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'permitecadastro': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'reunioes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Section']", 'null': 'True', 'blank': 'True'}),
            'site_externo': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
