...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cms_section', 'site_id')

        # Deleting field 'Article.site'
        db.delete_column('cms_article', 'site_id')

        # Deleting field 'FileDownload.site'
        db.delete_column('cms_filedownload', 'site_id')

        # Deleting field 'Menu.site'
        db.delete_column('cms_menu', 'site_id')

        # Deleting field 'URLMigrate.site'
        db.delete_column('cms_urlmigrate', 'site_id')


    def backwards(self, orm):
        # Adding field 'Section.site'
        db.add_column('cms_section', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Article.site'
        db.add_column('cms_article', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'FileDownload.site'
        db.add_column('cms_filedownload', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Menu.site'
        db.add_column('cms_menu', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'URLMigrate.site'
        db.add_column('cms_urlmigrate', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sites.Site']),
                      keep_default=False)
