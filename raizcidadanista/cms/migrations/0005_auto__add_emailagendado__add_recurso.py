...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailAgendado'
        db.create_table('cms_emailagendado', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(default='', max_length=90)),
            ('status', self.gf('django.db.models.fields.CharField')(default='S', max_length=1)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('to', self.gf('cms.fields.ListField')()),
            ('html', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('cms', ['EmailAgendado'])

        # Adding model 'Recurso'
        db.create_table('cms_recurso', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recurso', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('valor', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('ativo', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('cms', ['Recurso'])


    def backwards(self, orm):
        # Deleting model 'EmailAgendado'
        db.delete_table('cms_emailagendado')

        # Deleting model 'Recurso'
        db.delete_table('cms_recurso')
