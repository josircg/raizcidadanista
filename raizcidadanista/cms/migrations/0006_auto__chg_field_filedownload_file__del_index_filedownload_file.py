...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'FileDownload.file' to match new field type.
        db.rename_column('cms_filedownload', 'file_id', 'file')
        # Changing field 'FileDownload.file'
        db.alter_column('cms_filedownload', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
        # Removing index on 'FileDownload', fields ['file']
        db.delete_index('cms_filedownload', ['file_id'])


    def backwards(self, orm):
        # Adding index on 'FileDownload', fields ['file']
        db.create_index('cms_filedownload', ['file_id'])


        # Renaming column for 'FileDownload.file' to match new field type.
        db.rename_column('cms_filedownload', 'file', 'file_id')
        # Changing field 'FileDownload.file'
        db.alter_column('cms_filedownload', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']))
