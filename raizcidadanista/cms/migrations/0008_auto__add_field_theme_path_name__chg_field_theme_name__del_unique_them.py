...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Theme', fields ['name']
        db.delete_unique('cms_theme', ['name'])

        # Adding field 'Theme.path_name'
        db.add_column('cms_theme', 'path_name',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=60),
                      keep_default=False)


        # Changing field 'Theme.name'
        db.alter_column('cms_theme', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):
        # Deleting field 'Theme.path_name'
        db.delete_column('cms_theme', 'path_name')


        # Changing field 'Theme.name'
        db.alter_column('cms_theme', 'name', self.gf('django.db.models.fields.CharField')(max_length=12, unique=True))
        # Adding unique constraint on 'Theme', fields ['name']
        db.create_unique('cms_theme', ['name'])
