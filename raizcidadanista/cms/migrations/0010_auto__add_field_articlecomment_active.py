...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleComment.active'
        db.add_column('cms_articlecomment', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleComment.active'
        db.delete_column('cms_articlecomment', 'active')
