...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Theme.path'
        db.alter_column('cms_theme', 'path', self.gf('django.db.models.fields.FilePathField')(path='/media/BACKUP/Workspace/raizcidadanista/raizcidadanista/raizcidadanista/media/uploads/themes', max_length=256, recursive=True))

    def backwards(self, orm):

        # Changing field 'Theme.path'
        db.alter_column('cms_theme', 'path', self.gf('django.db.models.fields.FilePathField')(path='/media/BACKUP/Workspace/raizcidadanista/raizcidadanista/raizcidadanista/media/uploads/themes', max_length=100, recursive=True))
    ...
    models = {
        ...
        'cms.theme': {
            ...
            'path': ('django.db.models.fields.FilePathField', [], {'path': "'/media/BACKUP/Workspace/raizcidadanista/raizcidadanista/raizcidadanista/media/uploads/themes'", 'max_length': '256', 'recursive': 'True'}),
            'path_name': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '60'})
        },
        'cms.urlmigrate': {
