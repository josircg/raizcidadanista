...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cms_grouptype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
        ))
        db.send_create_signal('cms', ['GroupType'])

        # Adding model 'GroupItem'
        db.create_table('cms_groupitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('grouptype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.GroupType'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
        ))
        db.send_create_signal('cms', ['GroupItem'])


    def backwards(self, orm):
        # Deleting model 'GroupType'
        db.delete_table('cms_grouptype')

        # Deleting model 'GroupItem'
        db.delete_table('cms_groupitem')
