...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileDownload.create_article'
        db.add_column('cms_filedownload', 'create_article',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FileDownload.article'
        db.add_column('cms_filedownload', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Article'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileDownload.create_article'
        db.delete_column('cms_filedownload', 'create_article')

        # Deleting field 'FileDownload.article'
        db.delete_column('cms_filedownload', 'article_id')
