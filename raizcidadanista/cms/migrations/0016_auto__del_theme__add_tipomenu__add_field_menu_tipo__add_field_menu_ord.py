...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cms_tipomenu', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('cms', ['TipoMenu'])

        # Adding field 'Menu.tipo'
        db.add_column('cms_menu', 'tipo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.TipoMenu'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('cms_theme', (
            ('path_name', self.gf('django.db.models.fields.SlugField')(max_length=60, unique=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('path', self.gf('django.db.models.fields.FilePathField')(path='/media/BACKUP/Workspace/raizcidadanista/raizcidadanista/raizcidadanista/media/uploads/themes', max_length=256, recursive=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.delete_table('cms_tipomenu')

        # Deleting field 'Menu.tipo'
        db.delete_column('cms_menu', 'tipo_id')
    ...
    models = {
        ...
        'cms.menu': {
            'Meta': {'ordering': "('parent', 'order', 'id')", 'object_name': 'Menu'},
            ...
            'tipo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.TipoMenu']", 'null': 'True', 'blank': 'True'}),
