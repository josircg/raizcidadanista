...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailAgendado.from_email'
        db.add_column('cms_emailagendado', 'from_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailAgendado.from_email'
        db.delete_column('cms_emailagendado', 'from_email')
