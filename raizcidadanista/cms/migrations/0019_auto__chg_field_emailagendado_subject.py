...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailAgendado.subject'
        db.alter_column('cms_emailagendado', 'subject', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'EmailAgendado.subject'
        db.alter_column('cms_emailagendado', 'subject', self.gf('django.db.models.fields.CharField')(max_length=90))
