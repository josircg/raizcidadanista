...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticleAttribute'
        db.create_table('cms_articleattribute', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Article'])),
            ('attrib', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('cms', ['ArticleAttribute'])


    def backwards(self, orm):
        # Deleting model 'ArticleAttribute'
        db.delete_table('cms_articleattribute')
    ...
    models = {
        ...
        'cms.articleattribute': {
            'Meta': {'object_name': 'ArticleAttribute'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Article']"}),
            'attrib': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
