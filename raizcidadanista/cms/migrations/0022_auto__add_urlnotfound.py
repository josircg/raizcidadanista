...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'URLNotFound'
        db.create_table('cms_urlnotfound', (
        ...
        db.send_create_signal('cms', ['URLNotFound'])


    def backwards(self, orm):
        # Deleting model 'URLNotFound'
        db.delete_table('cms_urlnotfound')
    ...
    models = {
        ...
        'cms.urlnotfound': {
            'Meta': {'ordering': "('-update_at',)", 'object_name': 'URLNotFound'},
