...
VERSIONS = getattr(settings, "FILEBROWSER_VERSIONS", {
    'thumb': {'verbose_name': 'Admin Thumbnail', 'width': 75, 'height': 75, 'opts': 'crop'},
...
ADMIN_THUMBNAIL = getattr(settings, 'FILEBROWSER_ADMIN_THUMBNAIL', 'thumb')
