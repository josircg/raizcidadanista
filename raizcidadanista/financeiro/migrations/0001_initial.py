...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Conta'
        db.create_table('financeiro_conta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conta', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('descricao', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('tipo', self.gf('django.db.models.fields.CharField')(default='M', max_length=1)),
            ('ativa', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('nota', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('financeiro', ['Conta'])

        # Adding model 'Receita'
        db.create_table('financeiro_receita', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('dtaviso', self.gf('django.db.models.fields.DateField')()),
            ('valor', self.gf('utils.fields.BRDecimalField')(max_digits=12, decimal_places=2)),
            ('dtpgto', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('financeiro', ['Receita'])


    def backwards(self, orm):
        # Deleting model 'Conta'
        db.delete_table('financeiro_conta')

        # Deleting model 'Receita'
        db.delete_table('financeiro_receita')
