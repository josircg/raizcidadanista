...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetaArrecadacao'
        db.create_table('financeiro_metaarrecadacao', (
            ...
            ('data_limite', self.gf('django.db.models.fields.DateField')()),
            ('valor', self.gf('utils.fields.BRDecimalField')(max_digits=12, decimal_places=2)),
        ))
        db.send_create_signal('financeiro', ['MetaArrecadacao'])


    def backwards(self, orm):
        # Deleting model 'MetaArrecadacao'
        db.delete_table('financeiro_metaarrecadacao')
