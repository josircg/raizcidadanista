...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Receita.colaborador'
        db.alter_column('financeiro_receita', 'colaborador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Receita.colaborador'
        raise RuntimeError("Cannot reverse this migration. 'Receita.colaborador' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Receita.colaborador'
        db.alter_column('financeiro_receita', 'colaborador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro']))
