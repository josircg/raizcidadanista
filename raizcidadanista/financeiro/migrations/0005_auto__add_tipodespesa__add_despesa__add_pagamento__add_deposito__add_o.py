...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('financeiro_tipodespesa', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('codigo', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('descricao_breve', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('descricao', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal('financeiro', ['TipoDespesa'])

        # Adding model 'Despesa'
        db.create_table('financeiro_despesa', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fornecedor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Fornecedor'])),
            ('dtemissao', self.gf('django.db.models.fields.DateField')()),
            ('dtvencimento', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('documento', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('valor', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2)),
            ('integral', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('observacoes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('financeiro', ['Despesa'])

        # Adding model 'Pagamento'
        db.create_table('financeiro_pagamento', (
            ('operacao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['financeiro.Operacao'], unique=True, primary_key=True)),
            ('fornecedor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Fornecedor'])),
        ))
        db.send_create_signal('financeiro', ['Pagamento'])

        # Adding model 'Deposito'
        db.create_table('financeiro_deposito', (
            ('operacao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['financeiro.Operacao'], unique=True, primary_key=True)),
            ('receita', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Receita'], null=True, blank=True)),
        ))
        db.send_create_signal('financeiro', ['Deposito'])

        # Adding model 'Operacao'
        db.create_table('financeiro_operacao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Conta'])),
            ('tipo', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('dt', self.gf('django.db.models.fields.DateField')()),
            ('referencia', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('valor', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2)),
            ('conferido', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('obs', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('financeiro', ['Operacao'])

        # Adding model 'Fornecedor'
        db.create_table('financeiro_fornecedor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('identificador', self.gf('django.db.models.fields.CharField')(max_length=14)),
            ('dados_financeiros', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('servico_padrao', self.gf('django.db.models.fields.related.ForeignKey')(max_length=30, to=orm['financeiro.TipoDespesa'], null=True, blank=True)),
            ('ativo', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('financeiro', ['Fornecedor'])

        # Adding model 'PeriodoContabil'
        db.create_table('financeiro_periodocontabil', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ciclo', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('publico', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('financeiro', ['PeriodoContabil'])

        # Adding model 'Transferencia'
        db.create_table('financeiro_transferencia', (
            ('operacao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['financeiro.Operacao'], unique=True, primary_key=True)),
            ('destino', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Conta'])),
            ('transf_associada', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Transferencia'], null=True, blank=True)),
        ))
        db.send_create_signal('financeiro', ['Transferencia'])


    def backwards(self, orm):
        # Deleting model 'TipoDespesa'
        db.delete_table('financeiro_tipodespesa')

        # Deleting model 'Despesa'
        db.delete_table('financeiro_despesa')

        # Deleting model 'Pagamento'
        db.delete_table('financeiro_pagamento')

        # Deleting model 'Deposito'
        db.delete_table('financeiro_deposito')

        # Deleting model 'Operacao'
        db.delete_table('financeiro_operacao')

        # Deleting model 'Fornecedor'
        db.delete_table('financeiro_fornecedor')

        # Deleting model 'PeriodoContabil'
        db.delete_table('financeiro_periodocontabil')

        # Deleting model 'Transferencia'
        db.delete_table('financeiro_transferencia')
    ...
    models = {
        ...
        'financeiro.fornecedor': {
            ...
            'servico_padrao': ('django.db.models.fields.related.ForeignKey', [], {'max_length': '30', 'to': "orm['financeiro.TipoDespesa']", 'null': 'True', 'blank': 'True'})
        },
