...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pagamento.despesa'
        db.add_column('financeiro_pagamento', 'despesa',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['financeiro.Despesa']),
                      keep_default=False)


        # Changing field 'Fornecedor.servico_padrao'
        db.alter_column('financeiro_fornecedor', 'servico_padrao_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.TipoDespesa'], null=True))

    def backwards(self, orm):
        # Deleting field 'Pagamento.despesa'
        db.delete_column('financeiro_pagamento', 'despesa_id')


        # Changing field 'Fornecedor.servico_padrao'
        db.alter_column('financeiro_fornecedor', 'servico_padrao_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.TipoDespesa'], max_length=30, null=True))
    ...
    models = {
        ...
        'financeiro.pagamento': {
            ...
            'despesa': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financeiro.Despesa']"}),
            'fornecedor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financeiro.Fornecedor']"}),
            'operacao_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['financeiro.Operacao']", 'unique': 'True', 'primary_key': 'True'})
        },
