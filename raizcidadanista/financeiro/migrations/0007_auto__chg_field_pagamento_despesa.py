...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Pagamento.despesa'
        raise RuntimeError("Cannot reverse this migration. 'Pagamento.despesa' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Pagamento.despesa'
        db.alter_column('financeiro_pagamento', 'despesa_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Despesa']))
