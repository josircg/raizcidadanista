...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('financeiro_projeto', (
            ...
            ('orcamento', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=2)),
            ('dtinicio', self.gf('django.db.models.fields.DateField')()),
            ('dtfim', self.gf('django.db.models.fields.DateField')()),
        ...
        db.send_create_signal('financeiro', ['Projeto'])

        # Adding field 'Despesa.tipo_despesa'
        db.add_column('financeiro_despesa', 'tipo_despesa',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.TipoDespesa'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pagamento.projeto'
        db.add_column('financeiro_pagamento', 'projeto',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Projeto'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pagamento.tipo_despesa'
        db.add_column('financeiro_pagamento', 'tipo_despesa',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.TipoDespesa'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('financeiro_projeto')

        # Deleting field 'Despesa.tipo_despesa'
        db.delete_column('financeiro_despesa', 'tipo_despesa_id')

        # Deleting field 'Pagamento.projeto'
        db.delete_column('financeiro_pagamento', 'projeto_id')

        # Deleting field 'Pagamento.tipo_despesa'
        db.delete_column('financeiro_pagamento', 'tipo_despesa_id')
    ...
    models = {
        ...
        'financeiro.projeto': {
            ...
            'orcamento': ('django.db.models.fields.DecimalField', [], {'max_digits': '16', 'decimal_places': '2'}),
