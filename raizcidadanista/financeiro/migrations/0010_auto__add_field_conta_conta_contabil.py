...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conta.conta_contabil'
        db.add_column('financeiro_conta', 'conta_contabil',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conta.conta_contabil'
        db.delete_column('financeiro_conta', 'conta_contabil')
