...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Receita.notificado'
        db.add_column('financeiro_receita', 'notificado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Receita.notificado'
        db.delete_column('financeiro_receita', 'notificado')
