...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pagamento.despesa'
        db.alter_column('financeiro_pagamento', 'despesa_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['financeiro.Despesa'], null=True))

        # Changing field 'Pagamento.tipo_despesa'
        db.alter_column('financeiro_pagamento', 'tipo_despesa_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['financeiro.TipoDespesa'], null=True))

    def backwards(self, orm):

        # Changing field 'Pagamento.despesa'
        db.alter_column('financeiro_pagamento', 'despesa_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Despesa'], null=True))

        # Changing field 'Pagamento.tipo_despesa'
        db.alter_column('financeiro_pagamento', 'tipo_despesa_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.TipoDespesa'], null=True))
