...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContaContabil'
        db.create_table('financeiro_contacontabil', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('codigo', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('descricao', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('dtini', self.gf('django.db.models.fields.DateField')()),
            ('dtfim', self.gf('django.db.models.fields.DateField')()),
            ('ordem_sped', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('tipo_sped', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('financeiro', ['ContaContabil'])


    def backwards(self, orm):
        # Deleting model 'ContaContabil'
        db.delete_table('financeiro_contacontabil')
