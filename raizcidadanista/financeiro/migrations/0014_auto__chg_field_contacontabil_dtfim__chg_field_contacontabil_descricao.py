...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContaContabil.dtfim'
        db.alter_column('financeiro_contacontabil', 'dtfim', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ContaContabil.descricao'
        db.alter_column('financeiro_contacontabil', 'descricao', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'ContaContabil.dtfim'
        db.alter_column('financeiro_contacontabil', 'dtfim', self.gf('django.db.models.fields.DateField')(default=''))

        # Changing field 'ContaContabil.descricao'
        db.alter_column('financeiro_contacontabil', 'descricao', self.gf('django.db.models.fields.CharField')(max_length=60))
