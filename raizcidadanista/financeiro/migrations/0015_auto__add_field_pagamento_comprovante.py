...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pagamento.comprovante'
        db.add_column('financeiro_pagamento', 'comprovante',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pagamento.comprovante'
        db.delete_column('financeiro_pagamento', 'comprovante')
