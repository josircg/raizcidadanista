...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('financeiro_orcamento', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('periodo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.PeriodoContabil'])),
            ('periodo_final', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='final', null=True, to=orm['financeiro.PeriodoContabil'])),
            ('tipo_despesa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.TipoDespesa'])),
            ('valor', self.gf('utils.fields.BRDecimalField')(max_digits=14, decimal_places=2)),
            ('orcamento_pai', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Orcamento'])),
        ))
        db.send_create_signal('financeiro', ['Orcamento'])


        # Changing field 'MetaArrecadacao.valor'
        db.alter_column('financeiro_metaarrecadacao', 'valor', self.gf('utils.fields.BRDecimalField')(max_digits=14, decimal_places=2))

    def backwards(self, orm):
        # Deleting model 'Orcamento'
        db.delete_table('financeiro_orcamento')


        # Changing field 'MetaArrecadacao.valor'
        db.alter_column('financeiro_metaarrecadacao', 'valor', self.gf('utils.fields.BRDecimalField')(max_digits=12, decimal_places=2))
    ...
    models = {
        ...
        'financeiro.conta': {
            ...
            'conta_contabil': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
        ...
        'financeiro.contacontabil': {
            'Meta': {'object_name': 'ContaContabil'},
            ...
            'dtfim': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'dtini': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordem_sped': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'tipo_sped': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        'financeiro.deposito': {
        ...
        'financeiro.orcamento': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orcamento_pai': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financeiro.Orcamento']"}),
            'periodo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financeiro.PeriodoContabil']"}),
            'periodo_final': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'final'", 'null': 'True', 'to': "orm['financeiro.PeriodoContabil']"}),
            'tipo_despesa': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financeiro.TipoDespesa']"}),
            'valor': ('utils.fields.BRDecimalField', [], {'max_digits': '14', 'decimal_places': '2'})
        },
        'financeiro.pagamento': {
            'Meta': {'ordering': "['dt']", 'object_name': 'Pagamento', '_ormbases': ['financeiro.Operacao']},
            'comprovante': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'despesa': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': "orm['financeiro.Despesa']", 'null': 'True', 'blank': 'True'}),
            'fornecedor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financeiro.Fornecedor']"}),
            'operacao_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['financeiro.Operacao']", 'unique': 'True', 'primary_key': 'True'}),
            'projeto': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financeiro.Projeto']", 'null': 'True', 'blank': 'True'}),
            'tipo_despesa': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': "orm['financeiro.TipoDespesa']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'financeiro.receita': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nota': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'notificado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
