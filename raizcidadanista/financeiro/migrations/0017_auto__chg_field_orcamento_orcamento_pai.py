...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Orcamento.orcamento_pai'
        db.alter_column('financeiro_orcamento', 'orcamento_pai_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['financeiro.Orcamento'], null=True))

    def backwards(self, orm):

        # Changing field 'Orcamento.orcamento_pai'
        db.alter_column('financeiro_orcamento', 'orcamento_pai_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['financeiro.Orcamento']))
