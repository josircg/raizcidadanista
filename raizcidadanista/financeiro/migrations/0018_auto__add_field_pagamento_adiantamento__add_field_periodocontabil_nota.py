...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pagamento.adiantamento'
        db.add_column('financeiro_pagamento', 'adiantamento',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PeriodoContabil.nota'
        db.add_column('financeiro_periodocontabil', 'nota',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pagamento.adiantamento'
        db.delete_column('financeiro_pagamento', 'adiantamento')

        # Deleting field 'PeriodoContabil.nota'
        db.delete_column('financeiro_periodocontabil', 'nota')
