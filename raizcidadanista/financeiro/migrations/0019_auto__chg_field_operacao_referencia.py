...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Operacao.referencia'
        db.alter_column('financeiro_operacao', 'referencia', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Operacao.referencia'
        raise RuntimeError("Cannot reverse this migration. 'Operacao.referencia' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Operacao.referencia'
        db.alter_column('financeiro_operacao', 'referencia', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'financeiro.orcamento': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orcamento_pai': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['financeiro.Orcamento']", 'null': 'True', 'blank': 'True'}),
        ...
        'financeiro.pagamento': {
            ...
            'adiantamento': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
