...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Operacao.dt_criacao'
        db.add_column('financeiro_operacao', 'dt_criacao',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Operacao.dt_criacao'
        db.delete_column('financeiro_operacao', 'dt_criacao')
    ...
    models = {
        ...
        'financeiro.operacao': {
            ...
            'dt_criacao': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
