...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Operacao.dt_criacao'
        db.alter_column('financeiro_operacao', 'dt_criacao', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2016, 12, 14, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Operacao.dt_criacao'
        db.alter_column('financeiro_operacao', 'dt_criacao', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
