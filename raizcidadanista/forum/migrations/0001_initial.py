...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Topico'
        db.create_table('forum_topico', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Circulo'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('criador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro'])),
            ('dt_criacao', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('dt_ultima_atualizacao', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('visitacoes', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('forum', ['Topico'])

        # Adding model 'TopicoOuvinte'
        db.create_table('forum_topicoouvinte', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('topico', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Topico'])),
            ('ouvinte', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro'])),
            ('notificacao', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('dtentrada', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('forum', ['TopicoOuvinte'])

        # Adding model 'Conversa'
        db.create_table('forum_conversa', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('topico', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Topico'])),
            ('autor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro'])),
            ...
            ('conversa_pai', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Conversa'])),
        ))
        db.send_create_signal('forum', ['Conversa'])

        # Adding model 'ConversaCurtida'
        db.create_table('forum_conversacurtida', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Conversa'])),
            ('colaborador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro'])),
            ('curtida', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('forum', ['ConversaCurtida'])

        # Adding model 'Proposta'
        db.create_table('forum_proposta', (
            ('conversa_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['forum.Conversa'], unique=True, primary_key=True)),
            ('dt_encerramento', self.gf('django.db.models.fields.DateTimeField')()),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('forum', ['Proposta'])

        # Adding model 'Voto'
        db.create_table('forum_voto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proposta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Proposta'])),
            ('eleitor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro'])),
            ('voto', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('forum', ['Voto'])


    def backwards(self, orm):
        # Deleting model 'Topico'
        db.delete_table('forum_topico')

        # Deleting model 'TopicoOuvinte'
        db.delete_table('forum_topicoouvinte')

        # Deleting model 'Conversa'
        db.delete_table('forum_conversa')

        # Deleting model 'ConversaCurtida'
        db.delete_table('forum_conversacurtida')

        # Deleting model 'Proposta'
        db.delete_table('forum_proposta')

        # Deleting model 'Voto'
        db.delete_table('forum_voto')
    ...
    models = {
        ...
        'forum.conversa': {
            ...
            'conversa_pai': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forum.Conversa']"}),
