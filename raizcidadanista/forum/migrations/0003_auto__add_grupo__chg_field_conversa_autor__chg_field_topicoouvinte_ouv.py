...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Grupo'
        db.create_table('forum_grupo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal('forum', ['Grupo'])


        # Changing field 'Conversa.autor'
        db.alter_column('forum_conversa', 'autor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'TopicoOuvinte.ouvinte'
        db.alter_column('forum_topicoouvinte', 'ouvinte_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Voto.eleitor'
        db.alter_column('forum_voto', 'eleitor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'ConversaCurtida.colaborador'
        db.alter_column('forum_conversacurtida', 'colaborador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Topico.criador'
        db.alter_column('forum_topico', 'criador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Topico.grupo'
        db.alter_column('forum_topico', 'grupo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Grupo']))

    def backwards(self, orm):
        # Deleting model 'Grupo'
        db.delete_table('forum_grupo')


        # Changing field 'Conversa.autor'
        db.alter_column('forum_conversa', 'autor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro']))

        # Changing field 'TopicoOuvinte.ouvinte'
        db.alter_column('forum_topicoouvinte', 'ouvinte_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro']))

        # Changing field 'Voto.eleitor'
        db.alter_column('forum_voto', 'eleitor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro']))

        # Changing field 'ConversaCurtida.colaborador'
        db.alter_column('forum_conversacurtida', 'colaborador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro']))

        # Changing field 'Topico.criador'
        db.alter_column('forum_topico', 'criador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Membro']))

        # Changing field 'Topico.grupo'
        db.alter_column('forum_topico', 'grupo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cadastro.Circulo']))
