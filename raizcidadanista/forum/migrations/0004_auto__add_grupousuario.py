...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GrupoUsuario'
        db.create_table('forum_grupousuario', (
        ...
        db.send_create_signal('forum', ['GrupoUsuario'])


    def backwards(self, orm):
        # Deleting model 'GrupoUsuario'
        db.delete_table('forum_grupousuario')
