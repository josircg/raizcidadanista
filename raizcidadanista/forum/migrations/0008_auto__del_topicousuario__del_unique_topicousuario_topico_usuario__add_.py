...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TopicoOuvinte.dtleitura'
        db.add_column('forum_topicoouvinte', 'dtleitura',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2001, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding unique constraint on 'TopicoOuvinte', fields ['topico', 'ouvinte']
        db.create_unique('forum_topicoouvinte', ['topico_id', 'ouvinte_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TopicoOuvinte', fields ['topico', 'ouvinte']
        db.delete_unique('forum_topicoouvinte', ['topico_id', 'ouvinte_id'])
        ...
        # Deleting field 'TopicoOuvinte.dtleitura'
        db.delete_column('forum_topicoouvinte', 'dtleitura')
