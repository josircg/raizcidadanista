...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grupo.localizacao'
        db.add_column('forum_grupo', 'localizacao',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1),
                      keep_default=False)

        # Adding field 'Grupo.tematico'
        db.add_column('forum_grupo', 'tematico',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grupo.localizacao'
        db.delete_column('forum_grupo', 'localizacao')

        # Deleting field 'Grupo.tematico'
        db.delete_column('forum_grupo', 'tematico')
