...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConversaMencao'
        db.create_table('forum_conversamencao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Conversa'])),
            ('colaborador', self.gf('django.db.models.fields.related.ForeignKey')(related_name='conversao_colaborador_set', to=orm['auth.User'])),
            ('mencao', self.gf('django.db.models.fields.related.ForeignKey')(related_name='conversao_mencao_set', to=orm['auth.User'])),
        ))
        db.send_create_signal('forum', ['ConversaMencao'])


    def backwards(self, orm):
        # Deleting model 'ConversaMencao'
        db.delete_table('forum_conversamencao')
