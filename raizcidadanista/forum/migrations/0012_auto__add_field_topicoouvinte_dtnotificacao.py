...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopicoOuvinte.dtnotificacao'
        db.add_column('forum_topicoouvinte', 'dtnotificacao',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2001, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopicoOuvinte.dtnotificacao'
        db.delete_column('forum_topicoouvinte', 'dtnotificacao')
