...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GrupoCategoria'
        db.create_table('forum_grupocategoria', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Grupo'])),
            ('descricao', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal('forum', ['GrupoCategoria'])


    def backwards(self, orm):
        # Deleting model 'GrupoCategoria'
        db.delete_table('forum_grupocategoria')
