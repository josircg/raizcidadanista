...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topico.categoria'
        db.add_column('forum_topico', 'categoria',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['forum.GrupoCategoria'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topico.categoria'
        db.delete_column('forum_topico', 'categoria_id')
