...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PropostaOpcao'
        db.create_table('forum_propostaopcao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proposta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Proposta'])),
            ('opcao', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('forum', ['PropostaOpcao'])

        # Adding field 'Voto.opcao'
        db.add_column('forum_voto', 'opcao',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.PropostaOpcao'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Proposta.escopo'
        db.add_column('forum_proposta', 'escopo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PropostaOpcao'
        db.delete_table('forum_propostaopcao')

        # Deleting field 'Voto.opcao'
        db.delete_column('forum_voto', 'opcao_id')

        # Deleting field 'Proposta.escopo'
        db.delete_column('forum_proposta', 'escopo')
    ...
    models = {
        ...
        'forum.propostaopcao': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'opcao': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
