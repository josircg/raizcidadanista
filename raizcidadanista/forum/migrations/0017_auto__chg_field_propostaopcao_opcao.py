...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PropostaOpcao.opcao'
        db.alter_column('forum_propostaopcao', 'opcao', self.gf('django.db.models.fields.CharField')(max_length=120))

    def backwards(self, orm):

        # Changing field 'PropostaOpcao.opcao'
        db.alter_column('forum_propostaopcao', 'opcao', self.gf('django.db.models.fields.CharField')(max_length=1))
