...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Voto.conversa'
        db.add_column('forum_voto', 'conversa',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='conversa_voto_set', null=True, to=orm['forum.Conversa']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Voto.conversa'
        db.delete_column('forum_voto', 'conversa_id')
    ...
    models = {
        ...
        'forum.voto': {
            ...
            'conversa': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'conversa_voto_set'", 'null': 'True', 'to': "orm['forum.Conversa']"}),
