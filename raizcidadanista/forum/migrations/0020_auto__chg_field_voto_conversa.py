...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Voto.conversa'
        db.alter_column('forum_voto', 'conversa_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['forum.Conversa']))

    def backwards(self, orm):

        # Changing field 'Voto.conversa'
        db.alter_column('forum_voto', 'conversa_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['forum.Conversa']))
