...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConversaHistorico'
        db.create_table('forum_conversahistorico', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conversa_original', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Conversa'])),
            ('texto', self.gf('django.db.models.fields.TextField')()),
            ('dt_criacao', self.gf('django.db.models.fields.DateTimeField')()),
            ('arquivo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('forum', ['ConversaHistorico'])

        # Adding field 'Conversa.editada'
        db.add_column('forum_conversa', 'editada',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ConversaHistorico'
        db.delete_table('forum_conversahistorico')

        # Deleting field 'Conversa.editada'
        db.delete_column('forum_conversa', 'editada')
