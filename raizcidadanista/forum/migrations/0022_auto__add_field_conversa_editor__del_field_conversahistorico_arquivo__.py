...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversa.editor'
        db.add_column('forum_conversa', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='editor', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'ConversaHistorico.arquivo'
        db.delete_column('forum_conversahistorico', 'arquivo')

        # Adding field 'ConversaHistorico.autor'
        db.add_column('forum_conversahistorico', 'autor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversa.editor'
        db.delete_column('forum_conversa', 'editor_id')

        # Adding field 'ConversaHistorico.arquivo'
        db.add_column('forum_conversahistorico', 'arquivo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ConversaHistorico.autor'
        db.delete_column('forum_conversahistorico', 'autor_id')
    ...
    models = {
        ...
        'forum.conversa': {
            ...
            'editada': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'editor'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'forum.conversahistorico': {
            'Meta': {'ordering': "('dt_criacao',)", 'object_name': 'ConversaHistorico'},
            'autor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'conversa_original': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forum.Conversa']"}),
            'dt_criacao': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'texto': ('django.db.models.fields.TextField', [], {})
        },
        ...
        'forum.grupousuario': {
            'Meta': {'ordering': "('usuario__first_name', 'usuario__username')", 'unique_together': "(('grupo', 'usuario'),)", 'object_name': 'GrupoUsuario'},
        ...
        'forum.voto': {
            ...
            'conversa': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'conversa_voto_set'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['forum.Conversa']"}),
