...
urlpatterns = [
    ...
    url(r'^grupo/(?P<pk>\d+)/membros/$', login_required(views.GrupoMembrosView.as_view()), name='forum_grupo_membros'),
    ...
    url(r'^grupo/(?P<grupo_pk>\d+)/topico/(?P<pk>\d+)/mover/$', login_required(views.TopicoMoverView.as_view()), name='forum_topico_mover'),
    url(r'^grupo/(?P<grupo_pk>\d+)/topico/(?P<topico_pk>\d+)/conversa/(?P<pk>\d+)/historico/$', login_required(views.ConversaHistoricoView.as_view()), name='forum_topico_conversa_historico'),
