# -*- coding: utf-8 -*-
# Django settings for raizcidadanista project.
import os, sys
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, 'raizcidadanista.sqlite'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'lh6t(*rto_)b&amp;jw%augix*vgxjdxr-wwu!5_bxvk_y3)0&amp;-n-3'
...
WSGI_APPLICATION = 'raizcidadanista.wsgi.application'
...
ADMIN_TOOLS_MENU = 'raizcidadanista.menu.CustomMenu'
ADMIN_TOOLS_INDEX_DASHBOARD = 'raizcidadanista.dashboard.CustomIndexDashboard'
